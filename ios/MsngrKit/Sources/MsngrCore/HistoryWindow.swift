...
public enum HistoryWindow {
    ...
    /// Failures that never surface in the feed: the envelope was addressed to
    /// another device, carries our own content, or the message is a tombstone.
    public static let silentGapReasons: Set<String> = ["not_addressed", "own_echo", "deleted"]
