...
public enum WSOutgoing {
    ...
    // reaction, for the author of the message it lands on)
    case send(chatId: String, clientMsgId: String, sentAt: Double, body: Envelope, service: Bool,
              notify: Bool = false, notifyUser: String? = nil)
    ...
    public func encode() throws -> Data {
        ...
        case .send(let chatId, let clientMsgId, let sentAt, let body, let service, let notify, let notifyUser):
            ...
            if service, let notifyUser { obj["notifyUser"] = notifyUser }
