...
- Свои сбои продукт чинит сам: повтор в фоне, без участия человека. Пользователь
  узнаёт только о том, что требует его решения. Формулировки нейтральные, без
  технических причин и без заданий вроде «попросите отправителя» — кнопка
  действия появляется, только если это действие реально что-то меняет.
