...
- Комментарии в коде и сообщения коммитов — по-английски, только о текущем
  поведении. История изменений живёт в git, а не в комментариях. Существующие
  русские комментарии переводятся отдельным сплошным проходом; в файле, который
  правишь, переводить попутно не нужно, чтобы дифф оставался читаемым.
